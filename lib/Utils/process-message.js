...
const processMessage = async (message, { shouldProcessHistoryMsg, placeholderResendCache, ev, creds, keyStore, logger, options }) => {
    ...
    if (protocolMsg) {
        ...
        let participants;
        const emitParticipantsUpdate = (action) => { var _a, _b; return ev.emit('group-participants.update', { id: jid, author: message.participant, authorUsername: (_b = (_a = message.key) === null || _a === void 0 ? void 0 : _a.participantUsername) !== null && _b !== void 0 ? _b : undefined, participants, action }); };
        const emitGroupUpdate = (update) => {
            var _a, _b, _c;
            ev.emit('groups.update', [{ id: jid, ...update, author: (_a = message.participant) !== null && _a !== void 0 ? _a : undefined, authorUsername: (_c = (_b = message.key) === null || _b === void 0 ? void 0 : _b.participantUsername) !== null && _c !== void 0 ? _c : undefined }]);
        };
        const emitGroupRequestJoin = (participant, action, method) => {
            var _a, _b;
            ev.emit('group.join-request', { id: jid, author: message.participant, authorUsername: (_b = (_a = message.key) === null || _a === void 0 ? void 0 : _a.participantUsername) !== null && _b !== void 0 ? _b : undefined, participant, action, method: method });
        };
